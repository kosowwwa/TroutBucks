...
posted to #troutbucks-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The Troutbucks Project.
...
The "Troutbucks Maintainer Team" is defined in this document as the following users:
- fluffypony
- troutbucksmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Troutbucks code or Troutbucks's dependency code or Troutbucks's potential/future dependency code or research which successfully implements Troutbucks.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Troutbucks Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Troutbucks Maintainer Team.

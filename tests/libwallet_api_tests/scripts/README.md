...
* Running troutbucks node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/troutbucksexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/troutbucks/testnet_pvt```. 

#ifdef __APPLE__
  #define TROUTBUCKS_LOCAL_SYMBOL(x) .private_extern x
#else
  #define TROUTBUCKS_LOCAL_SYMBOL(x) .hidden x
#endif
...
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
TROUTBUCKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)

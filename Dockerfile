...
# Create troutbucks user
RUN adduser --system --group --disabled-password troutbucks && \
	mkdir -p /wallet /home/troutbucks/.bittroutbucks && \
	chown -R troutbucks:troutbucks /home/troutbucks/.bittroutbucks && \
	chown -R troutbucks:troutbucks /wallet

# Contains the blockchain
VOLUME /home/troutbucks/.bittroutbucks

# Generate your wallet via accessing the container and run:
# cd /wallet
# troutbucks-wallet-cli
VOLUME /wallet

EXPOSE 18080
EXPOSE 18081

# switch to user troutbucks
USER troutbucks

ENTRYPOINT ["troutbucksd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
